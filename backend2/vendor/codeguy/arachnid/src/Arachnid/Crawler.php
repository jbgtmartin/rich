...
class Crawler
{
    ...
    protected function checkIfCrawlable($uri)
    {
        ...
        $stop_links = array(
            ...
            '@^tel\:.*@i',
            '@^fax\:.*@i',
            '@\.(jpeg|pdf|flv|swf|png|jpg|gif|asx|zip|rar|tar|7z|gz|jar|js|css|dtd|xsd|ico|raw|mp3|mp4|wav|wmv|ape|aac|ac3|wma|aiff|mpg|mpeg|avi|mov|ogg|mkv|mka|asx|asf|mp2|m1v|m3u|f4v|doc|docx|xls|xlsx|ppt|pps|bin|exe|rss|xml)$@i'
        );
